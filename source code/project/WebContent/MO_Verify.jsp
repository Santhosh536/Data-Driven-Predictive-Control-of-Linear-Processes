...
<body>
	...
	<div class="ash">
		<center>
		<form action="MO_Verify.jsp" method="post">
		...
		<%					
			...
			<h3 style="font-family:Lucida Console;">LAB DATA</h3>
		</center>
		...
		<table class="w3-table-all w3-card-4 w3-hoverable">
  		...
  		<center>
			<h3 style="font-family:Lucida Console;">TANK CAPACITY DETAILS</h3>
		</center>
   <table class="w3-table-all w3-card-4 w3-hoverable">
  	<tr class="w3-orange">
  		<th>Tank A</th>
 ...
 <a	class="btn btn-lg hvr-underline-from-left"
				role="button" onclick="myFunction()"> UPDATE TO ADMIN </a>
				</center>
				<form action="Home_M_Operator.jsp" id="myForm"></form>
	<!-- footer -->
	<div class="footer">
		<div class="f-bg-w3l">
			<div class="container">
