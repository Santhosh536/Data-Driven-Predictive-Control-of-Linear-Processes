...
-- Dumping structure for table trsdb.recdetails
CREATE TABLE IF NOT EXISTS `recdetails` (
  `date` varchar(100) DEFAULT NULL,
  `field` varchar(100) DEFAULT NULL,
  `ph` varchar(100) DEFAULT NULL,
  `harmness` varchar(100) DEFAULT NULL,
  `solid` varchar(100) DEFAULT NULL,
  `clr` varchar(100) DEFAULT NULL,
  `cond` varchar(100) DEFAULT NULL,
  `sulph` varchar(100) DEFAULT NULL,
