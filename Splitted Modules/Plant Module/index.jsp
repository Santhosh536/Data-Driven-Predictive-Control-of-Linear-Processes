		...
		<div class="agileits_w3layouts_banner_nav">
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"> <span>W</span>ater Plant</a></h1>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu-hover-effect menu-hover-effect-4">
						<ul class="nav navbar-nav">
							<li class="active"><a href="index.jsp" class="hvr-ripple-in"> Home</a></li>
							<li><a href="Register.jsp" class="hvr-ripple-in">Register</a></li>
							<li><a href="Login.jsp" class="hvr-ripple-in">Login</a></li>
							<!-- <li class="dropdown">
...
<c:if test="${param.st eq 'reg'}">
						<p class="info"><img src="images/info.png" width="30" height="30"> User Registered Successfully</p>
						</c:if>
			...
			<div class="slider">
				<div class="wrapper">
					<div class="agile_banner_text_info">
						<h3 class="editContent"> <span class="editContent"> </span>WATER PLANT <label class="editContent"></label> </h3>
					</div>
					<!-- Slideshow 3 -->
	...
	<div class="about" id="welcome">
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="w3l_header w3_agileits_header two">Welcome <span>to our Deft</span></h3>
			</div>
