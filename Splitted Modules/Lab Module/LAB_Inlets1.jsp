...
<body>
	...
	<!--/w3_short-->
	<div class="hei">
			<button class="button1" name="button" value="OK" type="button" onclick="location.href ='Home_LAB.jsp';">
			<span>Back</span>
			</button>
	</div>
	<div class="ash">
		<center>
			<h3 style="font-family:Lucida Console;">WATER SAMPLES UPDATED</h3>
		</center>
					...
					try
				    {
						...
						while(rs.next())
						{
							...
							<tr>
								...
								<td><%=rs.getString("vol")%><%=rs.getString("unt")%></td>
								<td><a href="LAB_Inlets.jsp?dt=<%=rs.getString(1)%>&stc=<%=rs.getInt(18)%>">Test >></a></td>
							</tr>
							<%		
							k++;
						}
